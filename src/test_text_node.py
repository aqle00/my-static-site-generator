...
class TestTextNode(unittest.TestCase):
    ...
    def test_default_url_equals_explicit_none(self):
        node = TextNode("This is a text node", TextType.BOLD)
        node2 = TextNode("This is a text node", TextType.BOLD, None)
        self.assertEqual(node, node2)

    def test_url_none_not_eq_url(self):
        node = TextNode("This is a text node", TextType.BOLD)
        node2 = TextNode("This is a text node", TextType.BOLD, "url")
        self.assertNotEqual(node, node2)
    ...
    def test_repr(self):
        node = TextNode("This is a text node", TextType.BOLD, "url")
        self.assertEqual(repr(node), "TextNode(This is a text node, bold, url)")
